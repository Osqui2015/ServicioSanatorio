<?php
  ...
  $usuarioInfoMenu = mysqli_query($conServicios, "SELECT * FROM usuario");
                            ...
                            <div class="row">                            
                                ...
                                <div class="col">
                                    <select class="js-select-Nombre custom-select" name="Nombre" id="Nombre" onchange="selectUser()">
                                        ...
                                        ?>
                                            <option value="<?php echo utf8_encode($row['Id'])?>"> <?php echo utf8_encode($row['NombreApe'])?> </option>
                                        <?php }?>
                                    </select>
                                </div>
                                <div class="col">
                        ...
                        <tbody>                
                            ...
                            <?php while($row=mysqli_fetch_array($usuarioInfoMenu)) {?>
                                    <tr>
                                        ...
                                        <td> <a href="https://wa.me/+54<?php echo utf8_encode($row['Telefono']);?>" target="_blank" class="stretched-link"> <?php echo utf8_encode($row['Telefono']);?> </a> </td>
                                        <td> <?php echo utf8_encode($row['Email']);?> </td>
                                    
                                        <td>
                                            <!-- /* <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#masInfo" onclick="verinfo(<?php echo $row['usuario'];?>)">
                                                MAS INFO
                                            </button> */ -->
                                        </td>
                                    </tr>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer" id="btnGuardar" style="display:none">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button id = "btnagregarUser" type="button" class="btn btn-primary" onclick="guardarUser()" style="display:none">Guardar</button>
