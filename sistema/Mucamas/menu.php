...
<nav class="navbar navbar-expand-lg bg-body-tertiary navbar-custom">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">
      <img src="./img/logoCuatro.png" class="img-fluid" style="width: 150px; height: 65px;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active text-white fw-bold" href="#">Camas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active text-white fw-bold" href="reporte.php" hidden>Reportes</a>
        </li> 
        <li class="nav-item">
