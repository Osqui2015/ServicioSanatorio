            ...
            <div class="mx-auto" style="width: 1100px;"> <!-- Tabla Imagen-->                 
                <div class="card text-center">                    
                    <div class="card-body">                        
                            <div class="row">                            
                                ...
                                <div class="col">
                                    <select class="js-select-Especialidad custom-select" name="Especialidad" id="Especialidad" onchange="select()">
                                        <option value="00">TODOS</option>
                                        <?php 
                                            while($row=mysqli_fetch_array($menEspecialidad)) {
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="js-select-ObraSocial custom-select" name="ObraSocial" id="ObraSocial" onchange="select()">
                                        ...
                                        ?>
                                            <option value="<?php echo utf8_encode($row['Id'])?>"> <?php echo utf8_encode($row['Nombre'])?>ㅤㅤㅤㅤ<?php echo utf8_encode($row['Plan'])?> </option>
                                        <?php }?>
                                    </select>                                   
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#mCancelar">
                                        Agendas Canceladas
                                    </button>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-auto">
                    <input type='date' class="form-control" id="fechaCancelacion" onchange= "tablaCancelar()" />
                </div>                    
            </div>
            <br>
            <div class="row justify-content-md-center">
