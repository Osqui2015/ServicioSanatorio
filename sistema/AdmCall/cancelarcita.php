...
<!-- Modal -->
<div class="modal fade" id="EditarCancelacion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Editar Cancelación de turno</h5>
      ...
      <div class="modal-body">
          <div class="form-group">
            <label for="nombreDoctor">Nombre Doctor:</label>
              ...
              <input class="form-control" type="text" id="EMatricula">
          </div>
          <div class="form-group">
            <label for="tipoCancelacion">Tipo de Cancelación:</label>
            <select class="form-control" id="EtipoCancelacion">
              <option>Motivos personales</option>
              <option>Vacaciones</option>
              <option>Licencias</option> 
              <option>Congreso</option>             
          ...
          <div class="form-group">
            <label for="fechaInicio">Fecha Inicio:</label>
            <input type="date" class="form-control" id="EfechaInicio">
          </div>
          <div class="form-group">
            <label for="fechaFin">Fecha Fin:</label>
            <input type="date" class="form-control" id="EfechaFin">
          </div>
          <div class="form-group">
            <label for="observacion">Observación:</label>
            <textarea class="form-control" id="Eobservacion" rows="3"></textarea>
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="GEditCancelar()">Guardar Edit</button>
      </div>
    </div>
  </div>
</div>